<template>
  <div class="relative rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-5 sm:p-6 hover-effect" :class="{ 'overflow-hidden': loading }">
    <div
      v-if="loading"
