<template>
  ...
  >
    <div v-if="isShow" class="w-full min-w-[260px] max-w-xs p-4 bg-white rounded shadow-lg dark:bg-gray-800" role="alert">
      ...
      <div v-if="isProgress" class="relative block h-4 w-full rounded overflow-hidden bg-gray-200 dark:bg-gray-900/50 select-none mt-2">
        ...
        <div class="bg-blue-600 rounded h-4 overflow-hidden relative transition-all duration-500" :style="`width: ${getPercent}%`">
